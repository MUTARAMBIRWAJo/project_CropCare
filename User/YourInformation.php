...
<body>
    ...
    <div class="left-nav">
        <ul>
            <li><a href="YourInformation.php" style="background-color: gray;">Profile</a></li>
    ...
    <div class="center-content" style="align-content: center;width: 700px; text-align: center;
    font-family: Arial, Helvetica, sans-serif;font-size: x-large; border: 8px solid green;box-sizing: content-box;" >
        <p style="text-align: left;margin-top: 10px;margin-left: 20px; display: flex;">
           <h3 style="text-decoration: underline;">PROFILE DETAIL</h3>
        </p>
    </div>
